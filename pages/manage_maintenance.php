...
<head>
  ...
  <title>Maintenance Management Dashboard</title>
...
<body>
  <div class="container">
    ...
    <section class="main">
      ...
      <a href="add_maintenance.php">Add New Maintenance Record</a>
      <table>
        <thead>
          <tr>
        ...
        <tbody>
          ...
          if ($result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) {
              ...
              echo "<td>
                    <a href='edit_maintenance.php?id=" . $row['maintenance_id'] . "'><i class='fas fa-edit'></i> Edit</a> 
                    <a href='delete_maintenance.php?id=" . $row['maintenance_id'] . "'><i class='fas fa-trash-alt'></i> Delete</a>
                    </td>";
              echo "</tr>";
            }
          } else {
