    ...
    <tbody>
        ...
        if ($result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) {
                ...
                echo "<td>
                    <a href='edit_category.php?id=" . $row['category_id'] . "'><i class='fas fa-edit'></i> Edit</a> 
                    <a href='delete_category.php?id=" . $row['category_id'] . "'><i class='fas fa-trash-alt'></i> Delete</a>
                    </td>";
                echo "</tr>";
            }
        } else {
